...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func setupWindowRootController() {
        window = UIWindow()
    ...
    private func setupNavBarAppearance() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [.foregroundColor: UIColor.white, .font: UIFont.boldSystemFont(ofSize: 21)]
    }
